                ...
                <div className="logo-box">
                  <div className="logo">
                    <a href="index.html" title="Travilo">
                      <img src="images/logo.webp" alt="" title="Travilo" />
                    </a>
                  </div>
                </div>
                ...
                <div className="links-box clearfix">
                  ...
                  <div className="link lang-box">
                    <div className="lang-btn clearfix">
                      ...
                      <span className="icon far fa-angle-down" />
                    </div>
                  ...
                  <div className="link social">
                    <ul className="social-links clearfix">
                      {/* <li>
                        <a
                          href="https://www.facebook.com/www.otherpeople.uz?mibextid=LQQJ4d"
                          className="facebook"
                        >
                      ...
                      <li>
                        <a
                          href="https://instagram.com/silk_road_for_you?igshid=NTc4MTIwNjQ2YQ=="
                          className="twitter"
                        >
                  ...
                  <div className="link call-to">
                    <a href="tel:+998935609055">
                      <i className="icon fa fa-phone" /> {t("call_us")}{" "}
                      <span className="nmbr">+998935609055</span>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className="hidden-bar-wrapper">
            ...
            <div className="links-box clearfix">
              ...
              <ul className="d-flex" id="lang-list">
                ...
                <li className="mx-3" onClick={() => handleChangeLanguage("en")}>
                  <a>En</a>
                </li>
              </ul>
              <div className="link social">
                <ul
                  style={{ fontSize: "22px" }}
                  className="social-links clearfix d-flex justify-content-start"
                >
                  {/* <li>
                    <a
                      href="https://www.facebook.com/www.otherpeople.uz?mibextid=LQQJ4d"
                  ...
                  {/* <li>
                    <a href="http://t.me/+998935609055" className="linkedin">
                      <i className="fab fa-telegram" />
                    </a>
                  </li> */}
                  {/* <li>
                  ...
                  <li>
                    <a href="https://wa.me/998935609055" className="youtube">
                      <i className="fab fa-whatsapp" />
                    </a>
                  </li>
                </ul>
